...
import com.nexon.maple.openapi.client.character.response.PetEquipResponse;
...
public class PetEquipApi {
    ...
    Logger logger = LoggerFactory.getLogger(PetEquipApi.class);

    public PetEquipResponse get(String ocid, String date) {
        try {
            URI uri = new URIBuilder(mapleProperties.getBase() + characterProperties.getPetequip())
            ...
            if (response.getStatusLine().getStatusCode() == 200) {
                ...
                logger.info(body);
                PetEquipResponse res = ObjectMapperManager.camelToSnakeJsonMapper.readValue(body, PetEquipResponse.class);
                return res;
            } else {
