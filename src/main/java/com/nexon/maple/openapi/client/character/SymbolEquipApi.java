...
import com.nexon.maple.openapi.client.character.response.SymbolEquipResponse;
    ...
    public SymbolEquipResponse get(String ocid, String date) {
        try {
            ...
            if (response.getStatusLine().getStatusCode() == 200) {
                ...
                logger.info(body);
                SymbolEquipResponse res = ObjectMapperManager.camelToSnakeJsonMapper.readValue(body, SymbolEquipResponse.class);
                return res;
            } else {
