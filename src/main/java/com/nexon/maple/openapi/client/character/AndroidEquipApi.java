...
import com.nexon.maple.openapi.client.character.response.AndroidEquipResponse;
...
public class AndroidEquipApi {
    ...
    Logger logger = LoggerFactory.getLogger(AndroidEquipApi.class);

    public AndroidEquipResponse get(String ocid, String date) {
        try {
            URI uri = new URIBuilder(mapleProperties.getBase() + characterProperties.getAndroidequip())
            ...
            if (response.getStatusLine().getStatusCode() == 200) {
                ...
                logger.info(body);
                AndroidEquipResponse res = ObjectMapperManager.camelToSnakeJsonMapper.readValue(body, AndroidEquipResponse.class);
                return res;
            } else {
