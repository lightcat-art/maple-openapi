...
import com.nexon.maple.openapi.client.character.response.DojangResponse;
...
public class DojangApi {
    ...
    Logger logger = LoggerFactory.getLogger(DojangApi.class);

    public DojangResponse get(String ocid, String date) {
        try {
            URI uri = new URIBuilder(mapleProperties.getBase() + characterProperties.getDojang())
            ...
            if (response.getStatusLine().getStatusCode() == 200) {
                ...
                logger.info(body);
                DojangResponse res = ObjectMapperManager.camelToSnakeJsonMapper.readValue(body, DojangResponse.class);
                return res;
            } else {
