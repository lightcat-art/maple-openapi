...
import com.nexon.maple.openapi.client.character.response.BeautyEquipResponse;
    ...
    public BeautyEquipResponse get(String ocid, String date) {
        try {
            ...
            if (response.getStatusLine().getStatusCode() == 200) {
                ...
                logger.info(body);
                BeautyEquipResponse res = ObjectMapperManager.camelToSnakeJsonMapper.readValue(body, BeautyEquipResponse.class);
                return res;
            } else {
