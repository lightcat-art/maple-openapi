...
import com.nexon.maple.openapi.client.character.response.SetEffectResponse;
...
public class SetEffectApi {
    ...
    Logger logger = LoggerFactory.getLogger(SetEffectApi.class);

    public SetEffectResponse get(String ocid, String date) {
        try {
            URI uri = new URIBuilder(mapleProperties.getBase() + characterProperties.getSeteffect())
            ...
            if (response.getStatusLine().getStatusCode() == 200) {
                ...
                logger.info(body);
                SetEffectResponse res = ObjectMapperManager.camelToSnakeJsonMapper.readValue(body, SetEffectResponse.class);
                return res;
            } else {
