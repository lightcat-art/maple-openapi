...
import com.nexon.maple.openapi.client.character.response.PropensityResponse;
...
public class PropensityApi {
    ...
    Logger logger = LoggerFactory.getLogger(PropensityApi.class);

    public PropensityResponse get(String ocid, String date) {
        try {
            URI uri = new URIBuilder(mapleProperties.getBase() + characterProperties.getPropensity())
            ...
            if (response.getStatusLine().getStatusCode() == 200) {
                ...
                logger.info(body);
                PropensityResponse res = ObjectMapperManager.camelToSnakeJsonMapper.readValue(body, PropensityResponse.class);
                return res;
            } else {
