...
import com.nexon.maple.openapi.client.character.response.StatResponse;
...
public class StatApi {
    ...
    Logger logger = LoggerFactory.getLogger(StatApi.class);

    public StatResponse get(String ocid, String date) {
        try {
            URI uri = new URIBuilder(mapleProperties.getBase() + characterProperties.getStat())
            ...
            if (response.getStatusLine().getStatusCode() == 200) {
                ...
                logger.info(body);
                StatResponse res = ObjectMapperManager.camelToSnakeJsonMapper.readValue(body, StatResponse.class);
                return res;
            } else {
