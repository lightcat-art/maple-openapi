...
import com.nexon.maple.openapi.client.character.response.LinkSkillResponse;
...
public class LinkSkillApi {
    ...
    Logger logger = LoggerFactory.getLogger(LinkSkillApi.class);

    public LinkSkillResponse get(String ocid, String date) {
        try {
            URI uri = new URIBuilder(mapleProperties.getBase() + characterProperties.getLinkskill())
            ...
            if (response.getStatusLine().getStatusCode() == 200) {
                ...
                logger.info(body);
                LinkSkillResponse res = ObjectMapperManager.camelToSnakeJsonMapper.readValue(body, LinkSkillResponse.class);
                return res;
            } else {
