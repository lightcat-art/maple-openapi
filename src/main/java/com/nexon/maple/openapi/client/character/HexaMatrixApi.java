...
import com.nexon.maple.openapi.client.character.response.HexaMatrixResponse;
...
public class HexaMatrixApi {
    ...
    Logger logger = LoggerFactory.getLogger(HexaMatrixApi.class);

    public HexaMatrixResponse get(String ocid, String date) {
        try {
            URI uri = new URIBuilder(mapleProperties.getBase() + characterProperties.getHexamatrix())
            ...
            if (response.getStatusLine().getStatusCode() == 200) {
                ...
                logger.info(body);
                HexaMatrixResponse res = ObjectMapperManager.camelToSnakeJsonMapper.readValue(body, HexaMatrixResponse.class);
                return res;
            } else {
