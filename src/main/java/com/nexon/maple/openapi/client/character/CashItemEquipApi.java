...
import com.nexon.maple.openapi.client.character.response.CashItemEquipResponse;
...
public class CashItemEquipApi {
    ...
    Logger logger = LoggerFactory.getLogger(CashItemEquipApi.class);

    public CashItemEquipResponse get(String ocid, String date) {
        try {
            URI uri = new URIBuilder(mapleProperties.getBase() + characterProperties.getCashequip())
