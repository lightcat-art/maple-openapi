...
import com.nexon.maple.openapi.client.character.response.ItemEquipResponse;
...
public class ItemEquipApi {
    ...
    Logger logger = LoggerFactory.getLogger(ItemEquipApi.class);

    public ItemEquipResponse get(String ocid, String date) {
        try {
            URI uri = new URIBuilder(mapleProperties.getBase() + characterProperties.getItemequip())
            ...
            if (response.getStatusLine().getStatusCode() == 200) {
                ...
                logger.info(body);
                ItemEquipResponse res = ObjectMapperManager.camelToSnakeJsonMapper.readValue(body, ItemEquipResponse.class);
                return res;
            } else {
